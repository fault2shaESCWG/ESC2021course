...
if(nrlz <100)
HCfaulttab = readtable(fullfile(openquakepath,strcat('hazard_curve-rlz-0',num2str(nrlz),'-PGA_',OQ_RUN_ID,'.csv')),'HeaderLines',1,'ReadVariableNames',true);
elseif (nrlz <10)
HCfaulttab = readtable(fullfile(openquakepath,strcat('hazard_curve-rlz-00',num2str(nrlz),'-PGA_',OQ_RUN_ID,'.csv')),'HeaderLines',1,'ReadVariableNames',true);
else
...
h = textm(site(:,2),site(:,1)-0.28,sito,'FontSize',6);
