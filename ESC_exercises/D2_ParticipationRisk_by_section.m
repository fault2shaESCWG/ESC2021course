...
Tot = readtable(fullfile(openquakepath,strcat('damages-rlz-',num2str(nrlz),'_',OQ_RUN_ID,'.csv')),'HeaderLines',1,'ReadVariableNames',true);
end
% inputs
...
for j =1:(nrlz-1)
    ...
    T = [];
    if i>=100
        T = readtable(fullfile(openquakepath,strcat('damages-rlz-',num2str(i),'_',OQ_RUN_ID,'.csv ')),'HeaderLines',1,'ReadVariableNames',true);
    elseif i <100 & i>=10
        T = readtable(fullfile(openquakepath,strcat('damages-rlz-0',num2str(i),'_',OQ_RUN_ID,'.csv ')),'HeaderLines',1,'ReadVariableNames',true);
        
    elseif i <10
         T = readtable(fullfile(openquakepath,strcat('damages-rlz-00',num2str(i),'_',OQ_RUN_ID,'.csv ')),'HeaderLines',1,'ReadVariableNames',true);
    end
