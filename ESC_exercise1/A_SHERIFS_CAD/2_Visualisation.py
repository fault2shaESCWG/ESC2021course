...
import numpy as np
import os
#os.environ["PROJ_LIB"]= 'C:\\Users\\scotti-oon\\Anaconda3\\lib\\share'
...
class checking_the_input():
    def __init__(self):       
        ...
        self.Run_name = 'CAD_ESC_exercise'
        self.File_geom = 'data/CAD_ESC_exercise/Faults_geometry.txt'
        self.FileName_Prop = 'data/CAD_ESC_exercise/Faults_properties.txt'
        self.File_bg = 'data/CAD_ESC_exercise/Background_geometry.txt'
        self.completness_file = 'data/CAD_ESC_exercise/completness.txt'
        self.catalog_file = 'data/CAD_ESC_exercise/catalog.txt'
        self.file_faults_data = 'data/CAD_ESC_exercise/EQ_on_faults_data.txt'
        self.sub_area_file = 'data/sub_areas.txt'
