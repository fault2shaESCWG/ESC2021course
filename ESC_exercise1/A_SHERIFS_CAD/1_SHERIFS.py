...
Run_Name = 'CAD_ESC_exercise'
File_geom = 'data/CAD_ESC_exercise/Faults_geometry.txt'
File_prop = 'data/CAD_ESC_exercise/Faults_properties.txt'
File_bg = 'data/CAD_ESC_exercise/Background_geometry.txt'
file_prop_bg = 'data/CAD_ESC_exercise/Background_properties.txt'
host_model_file = 'delete_share.xml'
